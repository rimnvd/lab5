...
public class ElementManager {
    ...
    /**
     * Fills the characteristics of the dragon.
     */
    public void fields() {
        fields.clear();
        fieldsName();
            ...
            try {
                while (f) {
                    if (!list.equals("количество глаз") && !list.equals("размер головы")
                            ...
                            switch (list) {
                                case "имя":
                                    if (S.contains("<") || (S.contains(">"))) {
                                        System.out.println("Имя не может содержать такие символы, как \"<\" и \">\"");
                                    } else {
                                        f = false;
                                        name = S;
                                    }
                        ...
                        while (!answer.equalsIgnoreCase("YES") && !answer.equalsIgnoreCase("NO") && !f2) {
                            System.out.println("Вы хотите ввести размер головы и количество глаз? (YES/NO)");
                            answer = scanner.nextLine().trim();
                            System.out.println();
                        }
    ...
    /**
     * Sets the value of the color, type or character.
     *
     * @param S  The name of the enumeration
     * @param S1 set value
     * @return
     */
    ...
    /**
     * Sets the value of the all Integer or Double characteristics if it is possible
     *
     * @param S  the name of the characteristic
     * @param S1 set value
     ...
     *
     * @return true if the String S is empty; false otherwise
     */
